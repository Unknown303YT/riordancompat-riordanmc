...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> GODLY_ALTAR = registerBlock("godly_altar",
            () -> new GodlyAltarBlock(BlockBehaviour.Properties.copy(Blocks.SMOOTH_QUARTZ).noOcclusion()));
